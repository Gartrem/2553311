...
export default function Reviews() {
  return <section className="reviewsSection sectionLight" id="reviews" data-reveal>
    <div className="sectionHead"><div><span className="eyebrow">06 / Отзывы</span><h2>Говорят те, кто<br/><i>уже с нами работал.</i></h2></div><p>Несколько историй клиентов, опубликованных на исходном сайте студии. Текст ниже передаёт содержание отзывов кратко.</p></div>
