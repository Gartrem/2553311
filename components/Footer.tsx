...
export default function Footer() {
  return <footer className="footer">
    <div className="footerTop">
      ...
      <div className="footerContact"><span>Связаться с нами</span><a href="tel:+73832553311">+7 (383) 255-33-11</a><span>Новосибирск</span><div className="socialLinks"><a href="https://vk.com/mikhailsmirnovaar" target="_blank" rel="noopener noreferrer"><SocialIcon network="vk" />ВКонтакте</a><a href="https://t.me/SmirnovMikhailAAR" target="_blank" rel="noopener noreferrer"><SocialIcon network="telegram" />Телеграм</a><a href="https://www.youtube.com/user/MsMegel/featured" target="_blank" rel="noopener noreferrer"><SocialIcon network="youtube" />YouTube</a></div></div>
    </div>
