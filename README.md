...
- Во всех версиях шапки, мобильном меню и подвале используется предоставленный PNG-логотип без изменения рисунка. Светлая подложка сохраняет контраст с тёмным интерфейсом; favicon показывает увеличенный фрагмент того же изображения.
